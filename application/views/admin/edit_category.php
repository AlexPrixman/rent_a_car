...
<div class="card shadow mb-4">
    <div class="card-body">
        ...
        <form action="<?php echo base_url().'index.php/admin/update_category'?>" method="post">
            ...
            <div class="form-group row">
                <div class="col-sm-10 offset-sm-2">
                    ...
                    <a class="btn btn-danger" name="car_id" href="<?php echo base_url().'index.php/admin/category'; ?>">Cancelar</a>
                </div>
            </div>
        </form>
        <?php } ?>

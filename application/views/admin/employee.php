<div class="d-sm-flex align-items-center justify-content-between mb-4">
    ...
    <a href="<?php echo base_url().'admin/add_employee_act'; ?>" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i class="fas fa-plus fa-sm text-white-50"></i> Agregar Empleado</a>
</div>
            ...
            <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                ...
                ?>
                    <tr>
                        ...
                        <td>
                            <a class="btn btn-info btn-edit" href="<?php echo base_url().'index.php/admin/edit_employee/'.$k->employee_id; ?>">
                                <i class="fas fa-edit"></i> Editar
                            </a>
                            <a class="btn btn-danger btn-delete" href="<?php echo base_url().'index.php/admin/delete_employee/'.$k->employee_id; ?>">

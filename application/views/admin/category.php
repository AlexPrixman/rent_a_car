...
<div class="d-sm-flex align-items-center justify-content-between mb-4">
    ...
    <a href="<?php echo base_url().'index.php/admin/add_category_act'; ?>" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i class="fas fa-plus fa-sm text-white-50"></i> Agregar un Categoria</a>
</div>
            ...
            <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                ...
                ?>
                    <tr>
                        ...
                        <td>
                            <a class="btn btn-info btn-sm" href="<?php echo base_url().'index.php/admin/edit_category/'.$m->cat_id; ?>">
                                <i class="fas fa-edit"></i> Editar
                            </a>
                            <a class="btn btn-danger btn-sm btn-delete" href="<?php echo base_url().'index.php/admin/delete_category/'.$m->cat_id; ?>">
